...
inline ImColor main_color(204, 0, 255, 255);
inline ImVec4 color_particle(0.f, 0.f, 0.7f, 1.f);
...
inline ImVec4 tab_text_active = ImColor(52, 152, 255, 255);
inline ImVec4 tab_text_hov = ImColor(40, 116, 166, 255);
inline ImVec4 tab_text = ImColor(88, 92, 112, 255);

inline ImVec4 tab_active = ImColor(52, 152, 255, 255);
inline ImVec4 glow_active = ImColor(21, 226, 96, 230);

///////////////////////////////////////////// TEXT

inline ImVec4 text_active = ImColor(204, 0, 255);
inline ImVec4 text_hov = ImColor(250, 0, 255, 255);
inline ImVec4 text = ImColor(204, 0, 255, 255);

///////////////////////////////////////////// CHILD

inline ImVec4 child_background = ImColor(22, 21, 26, 255);
inline ImVec4 border_child = ImColor(28, 27, 32, 255);
inline ImVec4 child_gradient = ImColor(204, 0, 255, 255);

inline ImVec4 border_child_default = ImColor(22, 21, 26, 255);
inline ImVec4 child_name = ImColor(204, 0, 255, 255);

///////////////////////////////////////////// GRADIENT

inline ImVec4 checkbox_gradient_start = ImColor(204, 0, 255, 255);
inline ImVec4 checkbox_gradient_end = ImColor(204, 0, 255, 255);

///////////////////////////////////////////// CHECKBOXES

inline ImVec4 checkbox_bg = ImColor(4, 4, 4, 255);
inline ImVec4 checkbox_mark = ImColor(4, 4, 4, 255);
...
inline ImVec4 input_push_gradient = ImColor(52, 180, 255, 255);
inline ImVec4 input_pop_gradient = ImColor(52, 180, 255, 255);
...
inline ImVec4 keybind_border = ImColor(204, 0, 255, 255);
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    ImVec2 size = CalcItemSize(size_arg, label_size.x + style.FramePadding.x * 4.0f, label_size.y + style.FramePadding.y * 4.0f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        const int vtx_idx_1 = ImGui::GetWindowDrawList()->VtxBuffer.Size;
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Min + ImVec2(it_anim->second.slow - 7, 16.5f), GetColorU32(checkbox_gradient_start), 0, ImDrawFlags_RoundCornersLeft);
        ...
        window->DrawList->AddCircleFilled(frame_bb.Min + ImVec2(it_anim->second.slow - 1, 12.f), 8, GetColorU32(circle_push_gradient), 36);
...
bool ImGui::ColorPicker69(float* col, bool alphabar)
{
    ...
    if (!(flags & ImGuiColorEditFlags_NoSmallPreview))
    {
        ...
        if (BeginPopup("picker"))
        {
            if (g.CurrentWindow->BeginCount == 1)
            {
                ...
                //value_changed |= ColorPicker69(col &g.ColorPickerRef.x);
